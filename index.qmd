...
[Figure 5](https://www.nature.com/articles/s41467-021-21968-w/figures/5), shows an MSA of COVID spike proteins from several coronavirus species: SARS-CoV, SARS-CoV-2, MERS-COV, and HCoV-OC43 (the common cold). This visualization immediately left an impression on me. Clearly there is large divergence between these protein sequences, yet they share a region with enough similarity that these authors were able to identify antibodies that can bind to these relatively divergent species.

Let's see how we can use `gt` and MSAs to understand coronavirus protein sequences!
...
This 95 amino acid long region centers around the epitope that the antibodies bind to. There are structural components in this region where the epitope lies, the stem helix, the heptad repeat region 2 (HR2) and the transmembrane domain (TM). Click through the rest of these sections, as I use `gt` to help understand the amino acid composition of each protein region.
...
There are quite a few of bioinformatic color palettes for amino acids out there. I implemented a few different ones that I think help understand the amino acid composition. I will call them out in the following visualizations.
