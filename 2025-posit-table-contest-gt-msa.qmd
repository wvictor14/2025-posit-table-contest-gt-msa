...
format: 
  html:
    ...
    other-links:
      ...
      - text: Source Code
        icon: github
        href:  https://github.com/wvictor14/2025-posit-table-contest-gt-msa/ 
editor: 
  render-on-save: true
editor_options: 
...
#| column: screen
base_table |> 
  gt::data_color(columns = pos_91:pos_95, fn = apply_color_to_aa(palette = 'Taylor_AA')) |> 
